            ...
            if (hasStrokes) {
                ...
                if (strokeWidthToUse > 0f) {
                    ...
                    if (stroke1BmpCache == null || stroke1BmpCache!!.isRecycled || stroke1BmpHash != stroke1Hash) {
                        ...
                        val sh = if (isGrad) getGradientShader(getWidth(), getHeight()) else null
                ...
                // Punch hole (only punch hole if fill color is not fully transparent, or if gradient/silhouette is present)
                val fillAlpha = if (silhouetteColor != null) {
                    android.graphics.Color.alpha(silhouetteColor!!)
                } else if (isGradient) {
                    255
                } else {
